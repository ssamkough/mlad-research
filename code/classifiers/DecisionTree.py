...
def preprocess_five_class(input_path):
    ...
    dos_attacks = ['back', 'neptune', 'smurf', 'teardrop', 'land', 'pod', 'apache2', 'mailbomb', 'processtable',
                   'udpstorm']
    prob_attacks = ['satan', 'portsweep', 'ipsweep', 'nmap', 'mscan', 'saint']
    r2l_attacks = ['warezmaster', 'warezclient', 'ftp_write', 'guess_passwd', 'imap', 'multihop', 'phf', 'spy',
...
train_file = "C:/Users/Dylan J Laloo/Desktop/Research Boxiang Dong/SVMDecisionTree/kddcup.data_10_percent_corrected"  # training_small
test_file = "C:/Users/Dylan J Laloo/Desktop/Research Boxiang Dong/SVMDecisionTree/corrected"  # testing_small
